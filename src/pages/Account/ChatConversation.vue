<template>
    ...
    <q-toolbar>
      ...
      <q-toolbar-title class="text-weight-bold">
        ...
        <template v-if="order_id">
          <div class="text-caption">{{ $t("Order#") }} {{ order_id }}</div>
        </template>
      </q-toolbar-title>
      <q-avatar>
        <template v-if="getUserData[participant_user_uuid]">
  ...
  <q-page class="column">
    <div class="col">
      <q-scroll-area
        style="height: calc(75vh); width: 90%; margin: auto"
    ...
    <div class="col-3">
      <div
        ...
        class="q-pl-sm q-pr-sm full-width"
        :class="{
          'bg-grey600 ': $q.dark.mode,
          'bg-white text-dark  border-grey': !$q.dark.mode,
        }"
      >
        <q-uploader
          :url="chat_api_url"
    ...
    scrollTobottom() {
      setTimeout(() => {
        if (
          ...
          let value =
            parseInt(this.$refs.scroll_ref.getScroll().verticalSize) + 100;
